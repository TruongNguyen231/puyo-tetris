...
public class ImageController : MonoBehaviour
{
    ...
    public Dictionary<string, Sprite> bluePuyoImgDic = new Dictionary<string, Sprite>();
    public Dictionary<string, Sprite> greenPuyoImgDic = new Dictionary<string, Sprite>();
    public Dictionary<string, Sprite> purplePuyoImgDic = new Dictionary<string, Sprite>();
    public Dictionary<string, Sprite> redPuyoImgDic = new Dictionary<string, Sprite>();
    public Dictionary<string, Sprite> yellowPuyoImgDic = new Dictionary<string, Sprite>();
    public Dictionary<int, Sprite> numberImgDic = new Dictionary<int, Sprite>();
    public Dictionary<int, Sprite> shinyPuyoDic = new Dictionary<int, Sprite>();
    public GameObject comboGameObject;
    public Image digitsImage;
    public Image tenDigitsImage;
    ...
    {
        GameMaster.mainPuyoShinyObj.GetComponent<Image>().sprite = Instance.shinyPuyoDic[num];
    }
    ...
    public static void setComboNumber(int num)
    {
        ...
        if (tenDigits == 0)
        {
            Instance.tenDigitsImage.gameObject.SetActive(false);
        }
        else
        {
            Instance.tenDigitsImage.gameObject.SetActive(true);
        }
        Instance.digitsImage.sprite = Instance.numberImgDic[digits];
        Instance.tenDigitsImage.sprite = Instance.numberImgDic[tenDigits];
    }
    ...
    public static void setPuyoImage(Puyo puyo, string imgKey)
    {
        ...
        switch (puyo.getColor()) {
            case 0:
                puyoImage.sprite = Instance.bluePuyoImgDic[imgKey];
                break;
            case 1:
                puyoImage.sprite = Instance.greenPuyoImgDic[imgKey];
                break;
            case 2:
                puyoImage.sprite = Instance.purplePuyoImgDic[imgKey];
                break;
            case 3:
                puyoImage.sprite = Instance.redPuyoImgDic[imgKey];
                break;
            case 4:
                puyoImage.sprite = Instance.yellowPuyoImgDic[imgKey];
                break;
        }
    }
